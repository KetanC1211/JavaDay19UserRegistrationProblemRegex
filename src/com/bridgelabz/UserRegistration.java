...
public class UserRegistration {
	...
	// public static boolean checkMobileFormat(String mobileNumber)throws InvalidDetailsException {
	...
	public static void main(String[] args) {
		//Check First Name and throw custom exception
		try {
		...
		//Check Mobile number with try and catch and throw custom exception
		// try {
		// 	checkMobileFormat("91 9967945885");
		// }
		// catch(Exception e) {
		// 	System.out.println("Enter the proper input");
		// }
		//Check password with try and catch and throw custom exception
		try {
